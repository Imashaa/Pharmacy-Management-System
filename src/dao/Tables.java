...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //   st.executeUpdate("Insert into appuser(userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','14-04-2000','0771572722','admin@gmail.com','admin','admin','SriLanka')");
